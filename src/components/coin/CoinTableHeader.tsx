export function CoinTableHeader() {
    return (
        <div className="h-12 items-center grid grid-cols-[1fr_1.5fr_1fr_1fr_1fr_1fr_1fr_1fr] py-2 px-4 text-xs text-muted-foreground border-b bg-background font-semibold">
